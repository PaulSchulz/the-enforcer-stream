...
monthMarksDayText(\luastring{#1}, nil, \luastring{./data/moonphases-2026.csv})
tex.sprint(';')
}}
...
\newcommand{\publishingdate}{December 2025}
...
fight to expel the Russian invaders from their country.
...
\begin{tabular}{l l}
Title:     & The Leaf Spring Army 2026 Calendar \\
...
Copyright \textcopyright The Enforcer Media Group, 2025

\vspace{3mm}

\begin{minipage}{\textwidth}
This publication is copyright. All images used with permission.
\end{minipage}
}
